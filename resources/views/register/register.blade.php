                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            @if($type == 'Primary')
                                <div class="alert alert-warning">您現在填寫的是 國小教師 申請網頁 <a href="regJunior">帶我去國中申請頁面</a> </div>
                            @elseif($type == 'Junior')
                                <div class="alert alert-success">您現在填寫的是 國中教師 申請網頁 <a href="regPrimary">帶我去國小申請頁面</a></div>
                            @endif
                            <div class="form-group">
